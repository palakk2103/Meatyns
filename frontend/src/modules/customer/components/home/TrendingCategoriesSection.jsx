      ...
      <div className="flex items-center justify-between mb-3 sm:mb-4 px-1">
        <div className="flex items-center gap-2 sm:gap-2.5">
          <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-[#6B111F]/10 flex items-center justify-center text-[#6B111F]">
            <TrendingUp size={18} className="text-[#6B111F] sm:w-5 sm:h-5" />
          </div>
        ...
        {TRENDING_CATEGORIES.map((cat) => (
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              <h3 className="text-xs sm:text-sm md:text-base font-bold text-slate-900 group-hover:text-[#6B111F] transition-colors leading-tight truncate">
                {cat.name}
              </h3>

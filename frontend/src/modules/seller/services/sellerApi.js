...
export const sellerApi = {
    ...
    sendLoginOtp: (data) => axiosInstance.post('/seller/login-otp', data),
    verifyLoginOtp: (data) => axiosInstance.post('/seller/verify-login-otp', data),
    ...
    toggleStoreStatus: (data) => axiosInstance.patch('/seller/store-status', data),
    updateStoreHours: (data) => axiosInstance.put('/seller/store-hours', data),
    ...
    clearAllNotifications: () => axiosInstance.delete('/notifications?clearAll=true'),
